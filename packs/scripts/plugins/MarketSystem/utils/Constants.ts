 ...
 */
export const custom_content: Record<string, { texture: string; type: "block" | "item" }> = {
  "custom:block": {
...
export const number_of_custom_items =
  Object.values(custom_content).filter((v) => v.type === "item").length;
